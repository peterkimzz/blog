const name = "mdx";
const uuid = "fe65e2cd-7c73-4a27-8b5e-5902893626aa";
const fileTypes = [
	"mdx"
];
const patterns = [
...
export { mdx_tmLanguage as default, fileTypes, name, patterns, repository, scopeName, uuid };
