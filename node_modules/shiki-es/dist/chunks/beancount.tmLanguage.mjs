...
const scopeName = "text.beancount";
const uuid = "dbf28879-ee4d-497e-a678-a5c5a5e8d74f";
const beancount_tmLanguage = {
	fileTypes: fileTypes,
	name: name,
	patterns: patterns,
...
export { beancount_tmLanguage as default, fileTypes, name, patterns, repository, scopeName, uuid };
